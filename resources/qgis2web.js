...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:31984',
            //extent: [857889.159903, 9015472.071869, 959328.232576, 9183878.258985],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([939137.371158, 9068334.181104, 951656.074706, 9074703.746115], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Zoneamento do PDZ do Porto de  Suape</h2>';
        return titleElement;
    })(),
